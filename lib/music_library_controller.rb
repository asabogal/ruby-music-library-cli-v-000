...
class MusicLibraryController
  ...
  def call
    ...
    until input == "exit"
      ...
      puts
      puts "To list all of your SHITTY songs, enter 'list songs'."
      puts "To list all of the SHITTY artists in your library, enter 'list artists'."
      ...
      puts
      puts "What the fuck would you like to do? huh??"
